...
function Hexagon({w, h}) {
    return (
        <>
            ...
            <svg className={w.concat(` ${h} text-[#384572]`)} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                viewBox="0 0 483.013 483.013" style={{enableBackground:"new 0 0 483.013 483.013"}} fill="currentColor" space="preserve">
