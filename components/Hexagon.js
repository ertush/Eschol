        ...
        <>     
            ...
            <path   d="M477.043,219.205L378.575,48.677c-7.974-13.802-22.683-22.292-38.607-22.292H143.041c-15.923,0-30.628,8.49-38.608,22.292
                ...
                c15.925,0,30.634-8.491,38.607-22.293l98.469-170.543C485.003,249.99,485.003,233.006,477.043,219.205z" fill={isImage ? 'url(#img1)' : 'currentColor'}  />
             {
                 ...
                 (text?.split(' ').length > 1 ?  (
                    <>
                        <text className="capitalize text-5xl font-thin text-secondary" x="50%" y="42%" style={{strokeWidth:"2px", textAnchor:"middle"}} stroke="currentColor"  dy=".3em">{text.split(' ')[0]}</text>
                        <text className="capitalize text-5xl font-thin text-secondary" x="50%" y="57%" style={{strokeWidth:"2px", textAnchor:"middle"}} stroke="currentColor" dy=".3em">{text.split(' ')[1]}</text>
                    </>  
                  
                 ) : ( <text className="capitalize text-5xl font-thin text-secondary" x="50%" y="50%" style={{strokeWidth:"2px", textAnchor:"middle"}}  stroke="currentColor"  dy=".3em">{text}</text> )
                 )
