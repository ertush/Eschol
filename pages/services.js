...
function Services() {
    return (
        ...
        <div className="grid grid-cols-1 w-full gap-2 mx-auto py-8 px-5 h-auto place-content-start md:px-0 md:py-0">
            <div className="relative w-full md:h-[550px] h-[1300px]">
                ...
                <div className="z-20 absolute right-0 md:left-0 flex flex-col gap-y-2 justify-center items-start md:ml-5">
                    <h4 className=" md:w-1/2 w-full text-xl md:text-4xl font-bold md:font-extrabold text-white text-center  md:ml-0 mt-2 md:my-5">Investment Parameters</h4>
                ...
                {/* Investment Process */}
               <div className="z-20 w-full absolute top-[520px] md:right-0 flex flex-col gap-y-2 justify-center items-start md:ml-5">
                    <h4 className="md:w-1/2 w-full text-xl md:text-4xl font-bold md:font-extrabold text-white text-center  md:ml-0 mt-2 md:my-5">Investment Process</h4>

        
                        <Hexagon
                            hexaStyles={'w-[130px] h-[130px] text-yellow-500 absolute top-16 left-2'}
                        ...
                        <ArrowNarrowRightIcon className="w-8 h-8 text-yellow-500 absolute top-[110px] left-[154px]"/>

                        <Hexagon
                            hexaStyles={'w-[130px] h-[130px] text-yellow-500 absolute top-16 left-[200px] pr-1'}
                            textStyles={'text-primary text-5xl font-semibold y-27'}
                            text={'Confirm-Funding-Groups-to engage'}
                        />

                        <ArrowNarrowDownIcon className="w-8 h-8 text-yellow-500 absolute top-[200px] left-[250px]" />

                        <Hexagon
                            hexaStyles={'w-[130px] h-[130px] text-yellow-500 absolute top-60 left-[200px] pr-1'}
                            textStyles={'text-primary text-5xl font-semibold y-42'}
                            text={'Submission'}
                        />

                       <ArrowNarrowLeftIcon className="w-8 h-8 text-yellow-500 absolute top-[290px] left-[154px]" />

                       <Hexagon
                            hexaStyles={'w-[130px] h-[130px] text-yellow-500 absolute top-60 left-2'}
                            textStyles={'text-primary capitalize text-5xl font-semibold y-26'}
                            text={'Initial-Review-and Due-Diligence'}
                        />

                        <ArrowNarrowDownIcon className="w-8 h-8 text-yellow-500 absolute top-[386px] left-[55px]" />
                
                        <Hexagon
                            hexaStyles={'w-[130px] h-[130px] text-yellow-500 absolute top-[430px] left-2'}
                            textStyles={'text-primary capitalize text-5xl font-semibold y-36'}
                            text={'Outline-Terms-Issued'}
                        />

                        <ArrowNarrowRightIcon className="w-8 h-8 text-yellow-500 absolute top-[480px] left-[154px]"/>

                        <Hexagon
                            hexaStyles={'w-[130px] h-[130px] text-yellow-500 absolute top-[430px] left-[200px] pr-1'}
                            textStyles={'text-primary text-5xl font-semibold y-42'}
                            text={'Negotiations-& Clarification'}
                        />

                        <ArrowNarrowDownIcon className="w-8 h-8 text-yellow-500 absolute top-[570px] left-[250px]" />
              
                        <Hexagon
                            hexaStyles={'w-[130px] h-[130px] text-yellow-500 absolute top-[610px] left-[200px] pr-1'}
                            textStyles={'text-primary text-5xl font-semibold y-36'}
                            text={'Signature of-Contracts &-Appendices'}
                        />

                        <ArrowNarrowLeftIcon className="w-8 h-8 text-yellow-500 absolute top-[659px] left-[154px]" />
             
                        <Hexagon
                            hexaStyles={'w-[130px] h-[130px] text-yellow-500 absolute top-[610px] left-2 pr-1'}
                            textStyles={'text-primary text-5xl font-semibold y-36'}
                            text={'Drawdown'}
                        />
                </div>
